...
class SolicitaDescarga():
    ...
    def __generar_soapreq__(
            self, cer_der, key_der, passphrase, rfc_solicitante,
            fecha_inicial, fecha_final, rfc_emisor, rfc_receptor, tipo_solicitud
        ):
    ...
    def solicitar_descarga(
            self, cer_der, key_der, passphrase, rfc_solicitante, token,
            fecha_inicial, fecha_final, rfc_emisor=None, rfc_receptor=None, tipo_solicitud='CFDI'
        ):
        
        soapreq = self.__generar_soapreq__(
            cer_der, key_der, passphrase, rfc_solicitante,
            fecha_inicial, fecha_final, rfc_emisor, rfc_receptor, tipo_solicitud
        )
        ...
        s_d_r = resp_xml.find('s:Body/SolicitaDescargaResponse/SolicitaDescargaResult', namespaces=nsmap)
